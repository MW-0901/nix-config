...

{
  ...
  services.tlp.settings = {
    ...
    # CRITICAL: Disable USB autosuspend on AC to prevent keyboard disconnects
    USB_AUTOSUSPEND = 0;  # Disable entirely on AC
    ...
    USB_EXCLUDE_WWAN = 1;  # Don't autosuspend WWAN
    
    # On battery, still be selective
    USB_AUTOSUSPEND_ON_BAT = 1;  # Only enable on battery if needed
  };
